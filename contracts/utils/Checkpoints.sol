...
import "./math/SafeCast.sol";
 ...
 /**
 * @dev Library to support Compound-like voting and delegation. This version is more generic than Compound's,
 * and supports token supply up to 2^224^ - 1, while COMP is limited to 2^96^ - 1.
 *
 * NOTE: If exact COMP compatibility is required, use the {ERC20VotesComp} variant of this module.  (//FIXME)
 *
 * This library keeps a history (checkpoints) of each account's vote power. Vote power can be delegated either
